# .NET Client for VAG/VGN API
DotVGN is an unofficial .NET client for accessing the VAG/VGN public transport API. Query real-time departure data, station information, and transport schedules directly in your application.
