...
public class StationTests {
    ...
    public void StationQueryUrl_ForName_Simple() {
        ...
        Assert.Equal("haltestellen/vgn?name=Hauptbahnhof", url);
    }
    ...
    public void StationQueryUrl_ForName_MultipleWords() {
        ...
        var url = query.GetRelativeUriExtension();
        Assert.Equal("haltestellen/vgn?name=N%C3%BCrnberg%20Hbf", url);
    }
    ...
    public void StationQueryUrl_ForName_SpecialCharacters() {
        ...
        var url = query.GetRelativeUriExtension();
        Assert.Equal("haltestellen/vgn?name=M%C3%BCnchen-Schwabing", url);
    }
    ...
    public void StationQueryUrl_ForName_Umlauts() {
        ...
        var url = query.GetRelativeUriExtension();
        Assert.Equal("haltestellen/vgn?name=F%C3%BCrth%20Hbf", url);
    }
    ...
    public void StationQueryUrl_ForGeo_WholeNumbers() {
        ...
        var url = query.GetRelativeUriExtension();
        Assert.Equal("haltestellen/vgn/location?lon=11&lat=49&radius=300", url);
    }
    ...
    public void StationQueryUrl_ForGeo_FractionalCoordinates() {
        ...
        var url = query.GetRelativeUriExtension();
        Assert.Equal("haltestellen/vgn/location?lon=11.0778&lat=49.4521&radius=500", url);
    }
    ...
    public void StationQueryUrl_ForGeo_NegativeLatitude() {
        ...
        var url = query.GetRelativeUriExtension();
        Assert.Equal("haltestellen/vgn/location?lon=151.2153&lat=-33.8568&radius=1000", url);
    }
    ...
    public void StationQueryUrl_ForGeo_SmallRadius() {
        ...
        var url = query.GetRelativeUriExtension();
        Assert.Equal("haltestellen/vgn/location?lon=11.5&lat=49.5&radius=1", url);
    }
    ...
    public void StationQueryUrl_ForGeo_LargeRadius() {
        ...
        var url = query.GetRelativeUriExtension();
        Assert.Equal("haltestellen/vgn/location?lon=11.5&lat=49.5&radius=50000", url);
    }
    ...
    public void StationQueryUrl_ForGeo_HighPrecision() {
        ...
        var url = query.GetRelativeUriExtension();
        Assert.Equal("haltestellen/vgn/location?lon=11.987654321&lat=49.123456789&radius=250", url);
    }
}
